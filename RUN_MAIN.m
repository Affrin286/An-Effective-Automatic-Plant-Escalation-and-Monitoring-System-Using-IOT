...
% Last Modified by GUIDE v2.5 21-Mar-2017 14:45:34
...
if result == 0
    ...
    disp('Blast ');
elseif result == 1
    R2 = 'Result : Brown spot';
    set(handles.text34,'string',R2);   
    disp('Brown spot');
elseif result == 2
    R3 = 'Result : False smut';
    set(handles.text34,'string',R3);
    disp(' False smut ');
elseif result == 3
    R4 = 'Result : Leaf blight';
    set(handles.text34,'string',R4);
    disp('Leaf blight');
elseif result == 4
    R5 = 'Result : Leaf streak';
    R6 = 'None';
    set(handles.text34,'string',R5);
    disp(' Leaf streak ');
elseif result == 5
    R5 = 'Result : Healthy Leaf';
    R6 = 'None';
    set(handles.text34,'string',R5);
    disp('Healthy Leaf ');    
end
...
set(handles.text35,'string',['Accuracy : ', num2str(Max_Accuracy), ' % ']);
